const students = [{
    firstName: "מיכל", lastName: "שגיא", id: "123456789", gender: "זכר", date: "15/10/1993", address: { city: "עפרה", address: "המטע 2", other: "" }, hmo: "כללית", sensitivity: { sensitivity: "כן", more: "צליאק" }, phone: "0525000000", email: "michaldinner@gmail.com",
    ...
    service: ['אוטיזם', 'שיקום'], diagnosis: "תסמונת דאון",
...
{
    firstName: "רוחמה", lastName: "כהן", id: "123456789", gender: "נקבה", date: "15/10/2001", address: { city: "אחר", address: "התאנה 8", other: "מעלה עובש" }, sensitivity: { sensitivity: "לא" }, phone: "0525000000", email: "michalsagi.design@gmail.com",
