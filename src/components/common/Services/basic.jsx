...
function BasicFiles({ place ,saveFile, onClick,arrFile, setArrFile, student }) {
...
// ליצור תאריך תפוגה שיתן הזהרה לפני שנגמר התוקף
    ...
    return (
        ...
        <div className={"styles.container"}>
            ...
            {arrFile?.map((v, index) => {
                return (
                    <File saveFile={saveFile} place={place} placeholder={v.name} name={v.name} date={v.date}/>
                )
            })}
                ...
                return (
                    <div className={styles.remove}>
                        <div className={styles.removeBtn}>
                            <File saveFile={saveFile} place={place} optional fileName={fileName} setFileName={setFileName} name={`file optionaly ${index + 1}`} />
