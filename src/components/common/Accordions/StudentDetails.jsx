...
function StudentDetails({ data, setData, student }) {
    ...
    const [sensitivity, setSensitivity] = useState({ sensitivity: student?.sensitivity, more: student?.more })
        ...
        <Accordion defaultActiveKey={0}>
            <Accordion.Item eventKey={0}>
                ...
                <Accordion.Body>
                    ...
                    <Select defaultValue={student?.sensitivity} placeholder={"רגישות רפואית"} required={true} options={["כן", "לא"]} name={"sensitivity"} onChange={handleChangeSensitivity} />
                    {sensitivity?.sensitivity === "כן" || student?.sensitivity?.sensitivity === "כן" ? <Input defaultValue={student?.more} placeholder={"פירוט..."} required={true} name={"more"} onChange={handleChangeSensitivity} /> : ""
                    }
