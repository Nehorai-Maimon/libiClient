...
function DayCare_Para({ studentFiles, saveForm, saveFile, data, student, service }) {
    ...
    return <div>
        <FixedFiles studentFiles={studentFiles} saveFile={saveFile} student={student}  data={data} arrfile={arrfileFixed} service={service} />
