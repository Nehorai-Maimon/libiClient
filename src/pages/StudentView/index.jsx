            ...
            <div className={styles.main}>
                <div className={styles.container}>
                    <div className={styles.box}>
                        ...
                        <div className={styles.subContainer}>
                            <div className={styles.line}>  <span className={styles.question}>כתובת: </span>{student.address}</div>
                            <div className={styles.line}>  <span className={styles.question}>קופת חולים: </span>{student.hmo}</div>
                            <div className={styles.line}>  <span className={styles.question}>רגישות רפואית: </span>{student.sensitivity}</div>
                        </div>
                        <div className={styles.subContainer}>
